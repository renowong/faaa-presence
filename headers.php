<?php
$title="<title>Faa'a Pr&eacute;sence</title>\n";
...
$menucss="\t\t<link rel='stylesheet' type='text/css' href='css/csshorizontalmenu.css' />\n\t\t<script type='text/javascript' src='js/csshorizontalmenu.js'></script>\n";
$nocache="\t\t<meta http-equiv='pragma' content='no-cache' />\n";
$defaultcss="\t\t<link rel='stylesheet' type='text/css' href='css/main.css' />\n";
$cssreset="\t\t<link rel='stylesheet' type='text/css' href='css/reset.css' />\n";
