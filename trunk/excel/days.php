...
$days .= "<Row><Cell ss:Index=\"3\" ss:StyleID=\"ce26\"><Data ss:Type=\"String\">1</Data></Cell>";

for ($i=2;$i<=31;$i++){
    $days .= "<Cell ss:StyleID=\"ce26\"><Data ss:Type=\"String\">$i</Data></Cell>";
}

$days .="</Row>";

$days .="<Row ss:AutoFitHeight=\"0\" ss:Height=\"28.4904\"><Cell ss:MergeAcross=\"33\" ss:StyleID=\"ce6\"><Data ss:Type=\"String\">C E L L U L E     I N F O R M A T I Q U E</Data></Cell></Row>";
